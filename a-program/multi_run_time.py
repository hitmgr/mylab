...
path = '/home/mgr/sss/easyFL-FLGo/a-program/tasks/timeTry'
...
# 定义通用的Runner选项
option = {'log_file': True, 'num_rounds': 30, 'proportion': 1.0, 'learning_rate': 0.01, 'num_epochs': 1, 'sample': 'uniform'}
...
for partition in partitions:
    ...
    algorithm_list = ['MyAlgorithmTime', 'fedavg']
    ...
    for algorithm_name in algorithm_list:
        ...
        if algorithm_name == 'MyAlgorithmTime':
            ...
            simulator = ActivityHeterogeneitySimulator_fedavg
        else:
            # 退出并报错
